...
export default function Footer() {
  ...
  const contactEmail =
    settings?.site_email || "info@indosmilesouthservices.com";
  const contactPhone = settings?.site_phone || "+66 95 268 3663";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            {/* Fallback: show all socials if no settings loaded yet */}
            {activeSocials.length === 0 && (
              <div className="flex gap-4">
        ...
        <div className="border-t border-gray-700 pt-6 text-center">
          <p className="font-body text-gray-400 text-sm">
            ...
            {settings?.site_name || "Indo Smile South Services"}. All rights
            reserved.
          </p>
        </div>
      </div>
