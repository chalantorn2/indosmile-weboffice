export default function Footer() {
  const quickLinks = [
    ...
    { name: 'Inbound Tours', href: '#inbound' },
    { name: 'Outbound Tours', href: '#outbound' },
    { name: 'Land Operations', href: '#land-operations' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="font-body text-gray-300 hover:text-yellow transition-colors duration-200 text-sm"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              ...
              <p className="font-body text-gray-300 text-sm">
                indosmilesouthservices@gmail.com
              </p>
            </div>
        ...
        <div className="border-t border-gray-700 pt-6 text-center">
          <p className="font-body text-gray-400 text-sm">
            © {new Date().getFullYear()} Indo Smile South Services. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
