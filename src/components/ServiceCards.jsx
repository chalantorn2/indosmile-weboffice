  ...
  const services = [
    {
      ...
      title: "Island Tours",
      description:
        "Expertly curated travel experiences for international visitors exploring the beauty and culture of Southern Thailand.",
      link: "/inbound",
    },
    {
      icon: (
      ...
      description:
        "Seamless international travel packages designed for Thai travelers seeking memorable adventures around the world.",
      link: "/about#contact",
    },
    {
      icon: (
      ...
      title: "Transfer",
      description:
        "Comprehensive ground handling services including transportation, accommodation, and logistics management.",
      link: "/transfer",
    },
    {
      icon: (
      ...
      description:
        "Professional ticketing services and customized incentive travel programs for corporate groups and teams.",
      link: "/about#contact",
    },
  ];
